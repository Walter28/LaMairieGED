...
// Acte de naissance
const demandeActeNaissForm = document.getElementById('carteIdNatForm');
demandeActeNaissForm.addEventListener('submit', async e => {
    ...
    demande_body.append('type_document_id', 5);
    ...
    try {
        ...
        if (response.ok) {
            ...
            const url_acte = 'http://localhost:8000/api/cartes-identite-nationale'
